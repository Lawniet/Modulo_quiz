...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewCategory.setText("Filo: " + categoryName);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(QuizActivity.this, "Selecione uma reposta por favor", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            answered = false;
            buttonConfirmNext.setText("Confirma");
    ...
    private void updateCountDownText() {
        ...
        if (timeLeftInMillis < 20000 && timeLeftInMillis > 10000 ) {
            textViewCountDown.setTextColor(Color.parseColor("#FFA500"));
        }
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr()) {
            case 1:
                ...
                textViewQuestion.setText("A 1ª opção é a correta");
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                textViewQuestion.setText("A 2ª opção é a correta");
                break;
            case 3:
                rb3.setTextColor(Color.GREEN);
                textViewQuestion.setText("A 3ª opção é a correta");
                break;
            case 4:
                rb4.setTextColor(Color.GREEN);
                textViewQuestion.setText("A 4ª opção é a correta");
                break;
        }
